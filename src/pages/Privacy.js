            ...
            <section className="home">
                <div className="home__area">
                    <div className="footerPage__content">
                        <h1>個人情報保護方針</h1>
                        <p>合同会社occur（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
                        ...
                        <div className="footerPage__content__textbox">
                            ...
                            <p>住所：〒6510084 兵庫県神戸市中央区磯辺通2丁目2‐10ワンノットトレーズビル2階WAY・OUT内</p>
                            <p>社名：合同会社occur</p>
                            <p>Eメールアドレス：info@occur.co.jp</p>
                        </div>
